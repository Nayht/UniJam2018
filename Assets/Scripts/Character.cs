...
public class Character : MonoBehaviour
{
	...
	public float animation_time = 0.6f;
    ...
    void Start () {
		...
		counter_life = 0;
		mainSlider = GameObject.Find("LifeSlider").GetComponent<Slider>();
	...
	void Update () {
		if (is_player)
		{
			grow_old();
            turn();
            //Change(age, direction);//#optimisation #programmation-propre #GameJam
		}
	}
    void turn()
    {
